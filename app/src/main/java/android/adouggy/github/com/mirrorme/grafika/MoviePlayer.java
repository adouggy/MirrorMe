...
package android.adouggy.github.com.mirrorme.grafika;

import android.adouggy.github.com.mirrorme.MainActivity;
...
public class MoviePlayer {
    ...
    public MoviePlayer(File sourceFile, Surface outputSurface, FrameCallback frameCallback){
        Log.i(TAG, "construct MoviePlayer");
        ...
        try {
            ...
            Log.i(TAG, "Playing Video size is " + mVideoWidth + "x" + mVideoHeight);
            Log.i(TAG, "MoviePlayer..done");
        } catch(Throwable e){
        ...
        Log.i(TAG, "finish construct MoviePlayer");
    }
